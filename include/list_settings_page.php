...
if (! class_exists('Bilingual_List_Settings_Page')) {
    ...
    class Bilingual_List_Settings_Page
    {
...
EOD;
        ...
        public static function html($data)
        {
            return <<<EOD
<div class="wrap">
    <h1>Bilingual Wordpress List Settings</h1>
    <table class="wp-list-table widefat">
        <thead>
            <tr>
                <th colspan="5"><b>List Settings of Translation</b></th>
            </tr>
        </thead>
        <tbody>
